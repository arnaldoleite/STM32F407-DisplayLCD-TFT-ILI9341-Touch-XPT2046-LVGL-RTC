...
#include "touch/touch_calib.h"
/*********************
 *      DEFINES
 *********************/
#define TS_X_MIN  240
#define TS_X_MAX  1872
#define TS_Y_MIN  209
#define TS_Y_MAX  1872
	 ...
	 if (XPT2046_Pressed())
	    {
	        ...
	        /* Mapear para pixels */
	        data->point.x = (x - TS_X_MIN) * RESOLUTION_HORIZONTAL / (TS_X_MAX - TS_X_MIN);
	        data->point.y = (y - TS_Y_MIN) * RESOLUTION_VERTICAL / (TS_Y_MAX - TS_Y_MIN);
